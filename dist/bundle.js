...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "9d8cf25978cf6359af31";
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _lib_MailValidator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/MailValidator */ \"./src/lib/MailValidator.js\");\n/* harmony import */ var _lib_PasswordValidator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/PasswordValidator */ \"./src/lib/PasswordValidator.js\");\n/* harmony import */ var _lib_NameValidator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib/NameValidator */ \"./src/lib/NameValidator.js\");\n/* harmony import */ var _lib_UsernameValidator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib/UsernameValidator */ \"./src/lib/UsernameValidator.js\");\n/* harmony import */ var whatwg_fetch__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! whatwg-fetch */ \"./node_modules/whatwg-fetch/fetch.js\");\n/* harmony import */ var whatwg_fetch__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(whatwg_fetch__WEBPACK_IMPORTED_MODULE_4__);\n\n\n\n\n\n\nconst endpoint = \"http://localhost:3000\"\n\nconst validate = (params) => {\n  const {\n    name,\n    email,\n    password,\n    username\n  } = params;\n  const mailValidator = new _lib_MailValidator__WEBPACK_IMPORTED_MODULE_0__[\"default\"](email);\n  const passwordValidator = new _lib_PasswordValidator__WEBPACK_IMPORTED_MODULE_1__[\"default\"](password);\n  const nameValidator = new _lib_NameValidator__WEBPACK_IMPORTED_MODULE_2__[\"default\"](name)\n  const usernameValidator = new _lib_UsernameValidator__WEBPACK_IMPORTED_MODULE_3__[\"default\"](username)\n  return Promise.all([\n    nameValidator.validate(),\n    usernameValidator.validate(),\n    mailValidator.validate(),\n    passwordValidator.validate()]\n  )\n}\n\nconst removeErrors = () => {\n  return new Promise((resolve) => {\n    document.querySelectorAll('.is-invalid').forEach((el) => {\n      el.classList.remove('is-invalid')\n    })\n    document.querySelectorAll('.invalid-feedback').forEach((el) => {\n      el.parentNode.removeChild(el);\n    })\n    resolve();\n  })\n}\n\nconst addErrorMessage = (type, message) => {\n  let input = document.getElementById(type);\n  input.classList.add('is-invalid')\n  input.insertAdjacentHTML('afterend', `<div class=\"invalid-feedback\">${message}</div>`);\n}\n\nconst signup = (params) => {\n  return fetch(`${endpoint}/signup`, {\n    method: 'POST',\n    headers: {\n      Accept: 'application/json; charset=utf-8',\n      'Content-Type': 'application/json',\n    },\n    body: JSON.stringify(params)\n  })\n  .then((res) => {\n    const json = res.json();\n    if (res.status === 200) { // 登録成功\n      return json\n    } else { // 登録失敗\n      return Promise.reject(new Error('ユーザー登録失敗'))\n    }\n  })\n}\n\nconst onSubmit = async () => {\n  await removeErrors()\n  const emailInput = document.getElementById('email');\n  const passwordInput = document.getElementById('password');\n  const nameInput = document.getElementById('name');\n  const usernameInput = document.getElementById('username');\n  const email = emailInput.value;\n  const password = passwordInput.value;\n  const name = nameInput.value;\n  const username = usernameInput.value;\n  const params = {\n    email,\n    password,\n    username,\n    name\n  }\n  const results = await validate(params);\n  if (\n    results[0].success && \n    results[1].success &&\n    results[2].success &&\n    results[3].success) {\n    signup(params)\n      .then((json) => {\n        alert(json.message);\n      })\n      .catch((err) => {\n        alert(err.message);\n      });\n  } else {\n    results.forEach((result) => {\n      if (!result.success) addErrorMessage(result.type, result.message);\n    }) \n  }\n}\n\n{\n  const submit = document.getElementById('submit');\n  submit.addEventListener('click', onSubmit);\n}\n\n//# sourceURL=webpack:///./src/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _BaseValidator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BaseValidator */ \"./src/lib/BaseValidator.js\");\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (class extends _BaseValidator__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\n  constructor(val) {\n    super(val, 'メールアドレス', 'email');\n    this._checkFormat = this._checkFormat.bind(this);\n  }\n  validate() {\n    return super._cannotEmpty()\n      .then(this._checkFormat)\n      .then((res) => {\n        return { success: true }\n      })\n      .catch(err => {\n        return err\n      });\n  }\n  _checkFormat() {\n    const re = /^([^@\\s]+)@((?:[-a-z0-9]+\\.)+[a-z]{2,})$/i;\n    const match = re.test(this.val); // マッチするならtrue、しないならfalseを返す。\n    if (match) {\n      return Promise.resolve();\n    } else {\n      const message = `${this.typeName}のフォーマットが異なります。`\n      const errorResult = super._errorResult(message)\n      return Promise.reject(errorResult);\n    }\n  }\n});\n\n//# sourceURL=webpack:///./src/lib/MailValidator.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _BaseValidator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BaseValidator */ \"./src/lib/BaseValidator.js\");\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (class extends _BaseValidator__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\n  constructor(val) {\n    super(val, 'ユーザー名', 'username');\n    this._checkFormat = this._checkFormat.bind(this);\n  }\n  validate() {\n    return super._cannotEmpty()\n      .then(this._checkFormat)\n      .then((res) => {\n        return { success: true };\n      })\n      .catch(err => {\n        return err;\n      });\n  }\n  _checkFormat() {\n    const re = /^[a-zA-Z0-9_.-@]*$/i;\n    const match = re.test(this.val);\n    if (match) {\n      return Promise.resolve();\n    } else {\n      const message = `${this.typeName}には、半角英数字と記号のみが利用可能です。`\n      const errorResult = super._errorResult(message)\n      return Promise.reject(errorResult)\n    }\n  }\n\n});\n\n//# sourceURL=webpack:///./src/lib/UsernameValidator.js?");
